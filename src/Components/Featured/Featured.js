...
const Featured = (props) => {
    ...
    useEffect(() => {
        fetch(`https://api.themoviedb.org/3/discover/movie?api_key=2b1f693d67555b3bc4bc31399d43443b&language=en-US&sort_by=popularity.desc&primary_release_year=2023`)
            .then(response => response.json())
            .then(data => {
                const bestMovies = data.results
                setMoviesList(bestMovies);
            })
    }, [])

    return (
        <div className="featured container">
            <h3 className="row justify-content-center">Featured Movies</h3>
            <div
