...
const Upcoming = (props) => {
    ...
    useEffect(() => {
        fetch(`https://api.themoviedb.org/3/discover/movie?api_key=2b1f693d67555b3bc4bc31399d43443b&language=en-US&sort_by=popularity.desc&primary_release_date.gte=2024-01-01&primary_release_date.lte=2024-12-31`)
            .then(response => response.json())
            .then(data => {
                const bestMovies = data.results
                setUpcomingMovies(bestMovies);
            })
    }, [])

    return (
        <div className="featured container">
            <h3 className="row justify-content-center">Upcoming Movies</h3>
            <div
